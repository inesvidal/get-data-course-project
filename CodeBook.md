...
The information below has been obtained from the files [README.txt](https://github.com/inesvidal/get-data-course-project/blob/master/README_Raw_dataset.md) and [features_info.txt](https://github.com/inesvidal/get-data-course-project/blob/master/features_info_raw_dataset.md)
